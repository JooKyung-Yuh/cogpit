/**
 * Custom react-markdown components map for beautiful markdown rendering.
 * Inspired by assistant-ui, GitHub markdown CSS, and VS Code rendering.
 *
 * Provides element-level styling without relying on @tailwindcss/typography.
 */
...
/** Stable reference for remark plugins — avoids re-creating on every render. */
  ...
  a({ href, children }) {
    return (
      <a
        ...
        className="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 underline underline-offset-2 decoration-blue-500/30 hover:decoration-blue-500/60 transition-colors"
      >
        {children}
      </a>
    )
